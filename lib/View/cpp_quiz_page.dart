...
class CppQuizPage extends StatefulWidget {
  ...
  _CppQuizPageState createState() => _CppQuizPageState();
}

class _CppQuizPageState extends State<CppQuizPage> {
  int currentIndex = 0;
  ...
  void initState() {
    super.initState();
    quizCards = List<Flashcard>.from(cppmcqs)..shuffle();
